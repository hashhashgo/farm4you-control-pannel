<template>
 <div class="detail_tables">
   <el-table :data="markList" border :span-method="objectSpanMethod">
        <el-table-column label="植物受灾指标" width="135">
...
export default {
  ...
  data() {
    return {
      markList:[
       {FactorCode: 'NDVI', FactorName: '(2022.1)', FactorDivide: 0.80, DegreeLevel: '基本正常'},
       {FactorCode: 'NDVI', FactorName: '(2022.2)', FactorDivide: 0.79, DegreeLevel: '基本正常'},
       {FactorCode: 'NDVI', FactorName: '(2022.3)', FactorDivide: 0.77, DegreeLevel: '基本正常'},
       {FactorCode: 'NDVI', FactorName: '(2022.4)', FactorDivide: 0.82, DegreeLevel: '基本正常'},
       {FactorCode: 'NDVI', FactorName: '(2022.5)', FactorDivide: 0.33, DegreeLevel: '受灾严重'},
       {FactorCode: 'NDVI', FactorName: '(2022.6)', FactorDivide: 0.56, DegreeLevel: '需要改善'},
       ]
     }
  },
  methods: {
